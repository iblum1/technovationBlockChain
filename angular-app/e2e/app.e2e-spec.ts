...
describe('Starting tests for angular-app', function() {
  ...
  it('network-name should be whole-loan-trading@0.0.1',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('whole-loan-trading@0.0.1.bna');
    });
  });
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('Loan table should have 7 columns',() => {
      page.navigateTo('/Loan');
    ...
    it('Commitment table should have 9 columns',() => {
      page.navigateTo('/Commitment');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('SendLoan component should be loadable',() => {
      page.navigateTo('/SendLoan');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('SendLoan');
      });
    });
  
    it('CreateLoan component should be loadable',() => {
      page.navigateTo('/CreateLoan');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('CreateLoan');
      });
    });
