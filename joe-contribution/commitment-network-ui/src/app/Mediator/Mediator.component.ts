...
export class MediatorComponent implements OnInit {
  ...
  constructor(private serviceMediator:MediatorService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceMediator.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: "com.innovation.commitment.model.Mediator",
    ...
    return this.serviceMediator.addParticipant(this.participant)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceMediator.updateParticipant(form.get("partyId").value,this.participant)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceMediator.deleteParticipant(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceMediator.getparticipant(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
